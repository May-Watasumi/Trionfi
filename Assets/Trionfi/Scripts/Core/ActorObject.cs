...
{
    /*
        private static ActorDataBase _instance;
        public static ActorDataBase instance
        {
            get
            {
                if (_instance == null)
                {
                    ...
                    if (Application.isPlaying)
                        _instance = ScriptableObject.Instantiate<ActorDataBase>(Resources.Load("ActorDataBase") as ActorDataBase);
                    else
                        _instance = Resources.Load("ActorDataBase") as ActorDataBase;
    #else
                    _instance = Resources.Load("ActorDataBase") as ActorDataBase;
    #endif
                }
