...
namespace NovelEx
{
	public class JOKEREX : MonoBehaviour
	{
		private ErrorManager _errorManager = new ErrorManager();
		private MessageEx mainMessage = null;
		...
		private static JOKEREX jokerEx;

		public static JOKEREX Instance {
			get
			{
				return jokerEx;
			}
...
*/
		...
		/// </summary>
		private Func<GUIJokerInterface> guiInterfaceCreator;
		public GUIJokerInterface _uiInstance;
		public GUIJokerInterface uiInstance
		{
			get
			{
				if (!Instance.StatusManager.IsRunning)
				{
					return null;
				}
				...
				if (_uiInstance == null)
				{
					_uiInstance = guiInterfaceCreator();
				}
				return _uiInstance;
			}
...
//			clearSingleton();
		...
		public void Init(Func<GUIJokerInterface> paramGuiInterfaceCreator)
		{
			guiInterfaceCreator = paramGuiInterfaceCreator;
