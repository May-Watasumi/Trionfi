...
■利用規約
いわゆるMITライセンスになります。（参考：https://ja.wikipedia.org/wiki/MIT_License）
プロジェクト内にあるLICENSE（MITのライセンス・著作権表示）はそのまま添付してもらえればそれ以外は改変、商用利用等制限はありません。同時に、Trionfiの利用における何らかのトラブルに対して作者は一切の責任を負いません。
...
twitter
https://twitter.com/mahiru_hiroba
